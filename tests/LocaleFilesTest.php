...
/**
 * @file plugins/generic/ojsbrWebhook/tests/LocaleFilesTest.php
 *
...
class LocaleFilesTest extends PKPTestCase
{
    ...
    public const PLACEHOLDERS = [
        'plugins.generic.ojsbrWebhook.settings.testSentStatus' => ['{$status}'],
        'plugins.generic.ojsbrWebhook.settings.testFailedStatus' => ['{$error}', '{$status}'],
    ];
    ...
    public function testEveryKeyTheCodeUsesExists(): void
    {
        ...
        preg_match_all('/plugins\.generic\.ojsbrWebhook\.[a-zA-Z0-9_.]*[a-zA-Z0-9_]/', $sources, $m);
